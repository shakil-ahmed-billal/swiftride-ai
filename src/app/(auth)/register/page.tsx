    ...
    <div className="relative w-full min-h-screen lg:h-screen flex flex-col justify-between overflow-x-hidden lg:overflow-hidden bg-white lg:bg-[#0B132A]">
      ...
      <div className="hidden lg:block absolute inset-0 w-full h-full z-0 pointer-events-none">
        <Image
          ...
          alt="SwiftRide Register Backdrop"
          fill
          priority
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-5 sm:px-12 lg:px-16 py-6 sm:py-8 lg:py-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 h-full items-center">
        ...
        <div className="lg:col-span-5 xl:col-span-5 flex flex-col justify-between items-center lg:items-end w-full">
          ...
          {/* Desktop Top Right: Auth Switch Text + Back to Home Button */}
          ...
          <div className="w-full max-w-[450px] bg-white lg:bg-transparent p-0 sm:p-2 lg:p-3 my-auto">
            ...
            <div className="mb-4">
              ...
              <p className="text-[#596780] text-xs sm:text-sm font-normal mt-1 leading-relaxed">
                Sign up in seconds and explore our entire luxury fleet.
              </p>
            </div>

            {/* Error Message */}
            {errorMessage && (
              <div className="mb-3 p-3 bg-red-50 border border-red-200 text-red-700 rounded-[5px] text-xs flex items-center gap-2">
            ...
            {/* Success Message */}
            {successMessage && (
              <div className="mb-3 p-3 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-[5px] text-xs flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="w-4 h-4 rounded-[4px] border-slate-300 text-[#3563E9] focus:ring-[#3563E9] cursor-pointer"
                />
                <label
                  htmlFor="terms"
                  className="text-xs text-[#596780] cursor-pointer select-none"
                >
                  I agree to the{" "}
                  <a href="#terms" className="text-[#3563E9] hover:underline">
                    Terms & Conditions
                  </a>
                </label>
              </div>
